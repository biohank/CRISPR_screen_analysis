...
def calculatePhe(enrich_dic,rec_dic,arguments):
    ...
    if rec_dic['guide_type']=='double':    
        ...
        with open(file_in, 'wb') as out_open:
            ...
            'GeneAB double exp phe (pZ)', 'GeneAB double obs phe (pZ)','No. of elements for GeneAB double',\
            ...
            for key in genepair2tscore:
                ...
                out_csv.writerow([key,f_info,b_info,f_proc,b_proc,front_sko,front_no,back_sko,back_no,doubleexp,doubleobs,double_no,norm_gi,t_score,boot_strap,mwu,mwu_q])
